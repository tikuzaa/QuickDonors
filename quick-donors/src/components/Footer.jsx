...
const Footer = () => {
  return (
    <>
    <footer class="bg-[#fd5c63]/20 font-sans dark:bg-gray-900 translate-y-23">
    <div class="container px-6 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2">
                <h1 class="max-w-lg text-[50px] font-semibold tracking-tight text-gray-800 xl:text-[60px] dark:text-white">QuickDonor</h1>
                <p class="px-2 max-w-lg text-[xl] font-semibold tracking-tight text-gray-800 xl:text-[20px] dark:text-white">bujhe toko shob thik hobe</p>
        ...
        <p class="font-sans text-black p-8 text-start md:text-center md:text-lg md:p-4">© 2023 You Company Inc. All rights reserved.</p>
    </div>
</footer>
    </>
  );
