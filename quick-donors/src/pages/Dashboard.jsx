        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-6">
              ...
              <button onClick={findDonors} className="bg-red-100 text-red-600 w-full p-2 rounded-md mt-6 cursor-pointer hover:bg-red-200 transition">Search donors</button>
            </div>
