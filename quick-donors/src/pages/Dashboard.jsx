        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1 bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-6">
              ...
              >
                {loading ? <Loader2 className="animate-spin h-5 w-5" /> : "Search donors"}
              </button>
            </div>

            <div className="space-y-4">
              <h3 className="text-sm font-medium text-gray-700">Available Donors</h3>
              {donors.length > 0 ? (
                donors.map((donor) => (
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <div className="flex items-center">
                          ...
                          <span className="ml-2 font-medium">{donor.username}</span>
                        </div>
                        ...
                        <div className="mt-1 flex items-center text-sm text-gray-500">
                          ...
                          <span>{(donor.distance / 1000).toFixed(2)} km away</span>
                        </div>
                        <div className="mt-1 flex items-center text-sm text-gray-500">
                ...
                <h1 className="text-center opacity-75 text-red-600">Sorry, no donor found nearby</h1>
              )}
            </div>
          </div>
