...
const Dashboard = () => {
    ...
    <>
<Navbar></Navbar>
<div class="flex flex-col-3 justify-center items-center min-h-screen ">
  <div class="flex flex-row justify-center h-full w-full ">
    ...
    <div class= "flex flex-row bg-[#EEEEEE] px-5">
      <div class="bg-[#EEEEEE] px-5">
        <div class="relative mx-auto w-70 pb-4 rounded-full">
        <span class="relative flex size-7 ml-auto">
        <span class="absolute right-0  m-11 h-5 w-5  animate-ping rounded-full bg-green-400 opacity-75 ring-2 ring-green-400 ring-offset-1"></span>
        <span class="absolute right-0 m-11 h-5 w-5 size-7 rounded-full bg-green-500 ring-2 ring-green-500 ring-offset-1"></span>
        </span>
        ...
        <ul class="mt-3 divide-y rounded bg-gray-100 py-2 px-5 text-gray-600 shadow-sm hover:text-[#8E1616] hover:shadow w-[300px]">
          <li class="flex items-center py-3 text-sm">
            ...
            <span class="ml-auto"><span class="rounded-full bg-green-200 py-1 px-2 text-xs font-medium text-green-700">O+</span></span>
          </li>
          <li class="flex items-center py-3 text-sm">
    ...
    <div class="mb-5 w-full">
      ...
      <div class="grid grid-cols-1 rows-6 gap-5 w-full">
        <div class="rounded-lg border bg-white p-4 shadow-lg">
        <div class="flex flex-row justify-center w-full"> 
          <div><h2 class="text-lg font-bold">Donor Name 1</h2>
        ...
        <div class="rounded-lg border bg-white p-4 shadow-lg">
        <div class="flex flex-row justify-center w-full"> 
          <div class=""><h2 class="text-lg font-bold">Donor Name 2</h2>
          <p class="text-[#8E1616]">Distance: 2.5 km</p>
          <button class="mt-2 rounded-md bg-[#D84040] px-3 py-1 text-white font-semibold hover:bg-[#8E1616]">Contact</button>
          </div>
          <div class="relative ml-auto w-22 rounded-full">
        ...
        <div class="rounded-lg border bg-white p-4 shadow-lg">
        <div class="flex flex-row justify-center w-full"> 
          <div class=""><h2 class="text-lg font-bold">Donor Name 3</h2>
          <p class="text-[#8E1616]">Distance: 2.5 km</p>
          <button class="mt-2 rounded-md bg-[#D84040] px-3 py-1 text-white font-semibold hover:bg-[#8E1616]">Contact</button>
          </div>
          <div class="relative ml-auto w-22 rounded-full">
        ...
        <div class="rounded-lg border bg-white p-4 shadow-lg">
        <div class="flex flex-row justify-center w-full"> 
          <div class=""><h2 class="text-lg font-bold">Donor Name 4</h2>
          <p class="text-[#8E1616]">Distance: 2.5 km</p>
          <button class="mt-2 rounded-md bg-[#D84040] px-3 py-1 text-white font-semibold hover:bg-[#8E1616]">Contact</button>
          </div>
          <div class="relative ml-auto w-22 rounded-full">
        ...
        <div class="rounded-lg border bg-white p-4 shadow-lg">
        <div class="flex flex-row justify-center w-full"> 
          <div class=""><h2 class="text-lg font-bold">Donor Name 5</h2>
          <p class="text-[#8E1616]">Distance: 2.5 km</p>
          <button class="mt-2 rounded-md bg-[#D84040] px-3 py-1 text-white font-semibold hover:bg-[#8E1616]">Contact</button>
          </div>
          <div class="relative ml-auto w-22 rounded-full">
        ...
        <div class="rounded-lg border bg-white p-4 shadow-lg">
        <div class="flex flex-row justify-center w-full"> 
          <div class=""><h2 class="text-lg font-bold">Donor Name 6</h2>
          <p class="text-[#8E1616]">Distance: 2.5 km</p>
          <button class="mt-2 rounded-md bg-[#D84040] px-3 py-1 text-white font-semibold hover:bg-[#8E1616]">Contact</button>
          </div>
          <div class="relative ml-auto w-22 rounded-full">
    ...
    <div class="flex flex-col w-full justify-center mx-5 ">
        <h2 class="text-xl font-bold mb-3">Live Map of Available Donors</h2>
        <div class="border rounded-lg h-full flex items-center justify-center bg-[#EEEEEE] shadow-lg">
