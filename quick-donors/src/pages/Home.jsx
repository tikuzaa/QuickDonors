    ...
    <>
      <div className="bg-[#3D0301]">
        <header className="sticky top-0 z-50">
          <nav
            aria-label="Global"
            className="flex items-center justify-between p-7 lg:px-8 bg-[#56021F]/95 rounded-b-2xl z-50"
          >
            ...
            <div className="hidden gap-x-6 lg:flex lg:justify-end">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="relative text-md text-white after:absolute after:left-0 py-0.5
                  after:bottom-0 after:h-[2px] after:w-0 after:bg-[#B03052] after:transition-all after:duration-300 hover:after:w-full"
                >
                  {item.name}
                </a>
              ))}
              <a href="#" className="relative text-md px-2 py-0 text-white transition-all 
        ...
        <div className="relative isolate px-6 pt-5 lg:px-8 min-h-screen overflow-hidden">
          <div
            aria-hidden="true"
